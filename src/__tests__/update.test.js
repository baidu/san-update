...
describe('update method', () => {
    ...
    it('should update array by index', () => {
        ...
        result.foo[2] = 3;
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfChange(['foo', 2], 3, 4));
    });
    ...
    it('should update a nested property value', () => {
        ...
        result.tom.jack = 1;
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfChange(['tom', 'jack'], 1, 2));
    });
    ...
    it('should create nested property if not exist', () => {
        ...
        delete result.a;
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfAdd(['a', 'b'], 2));
    });
    ...
    it('should recognize push command', () => {
        ...
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray(['x', 'y', 'z'], [1, 2, 3], [1, 2, 3, 4], 3, 0, [4]));
    });

    it('should throw running push command on none array', () => {
        let source = {x: {}};
        expect(() => withDiff(source, {x: {$push: 1}})).toThrow();
    });
    ...
    it('should recognize unshift command', () => {
        ...
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray(['x', 'y', 'z'], [1, 2, 3], [0, 1, 2, 3], 0, 0, [0]));
    });

    it('should throw running unshift command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$unshift: 1}})).toThrow();
    });
    ...
    it('should recognize pop command', () => {
        ...
        result.foo = [1, 2, 3];
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray('foo', [1, 2, 3], [1, 2], 3, 1, []));
    });
    ...
    it('should throw running pop command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$pop: false}})).toThrow();
    });
    ...
    it('should recognize shift command', () => {
        ...
        result.foo = [1, 2, 3];
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray('foo', [1, 2, 3], [2, 3], 3, 1, []));
    });
    ...
    it('should throw running shift command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$shift: false}})).toThrow();
    });
    ...
    it('should recognize removeAt command', () => {
        ...
        result.x.y.z = [1, 2, 3];
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray(['x', 'y', 'z'], [1, 2, 3], [1, 3], 1, 1, []));
    });

    it('should throw running removeAt command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$removeAt: 1}})).toThrow();
    });
    ...
    it('should recognize remove command', () => {
        ...
        result.x.y.z = [1, 2, 3];
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray(['x', 'y', 'z'], [1, 2, 3], [2, 3], 0, 1, []));
    });

    it('should throw running remove command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$remove: 1}})).toThrow();
    });
    ...
    it('should recognize splice command', () => {
        ...
        result.x.y.z = [1, 2, 3];
        expect(result).toEqual(source);
        expect(diff).toEqual(diffOfArray(['x', 'y', 'z'], [1, 2, 3], [1, 6, 7, 8, 3], 1, 1, [6, 7, 8]));
        let [negativeStartRes] = withDiff(source, {x: {y: {z: {$splice: [-1, 1]}}}});
        expect(negativeStartRes.x.y.z).toEqual([1, 2]);
    });

    it('should throw running splice command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$splice: [1, 0, 1]}})).toThrow();
    });
    ...
    it('should recognize map command', () => {
        ...
        expect(diff).toEqual(diffOfChange('x', [1, 2, 3], [2, 3, 4]));
    });

    it('should throw running map command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$map: value => value + 1}})).toThrow();
    });
    ...
    it('should recognize filter command', () => {
        ...
        expect(diff).toEqual(diffOfChange('x', [1, 2, 3], [2, 3]));
    });

    it('should throw running filter command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$filter: value => value > 1}})).toThrow();
    });
    ...
    it('should recognize reduce command', () => {
        ...
        expect(diff).toEqual(diffOfChange('x', [1, 2, 3], 6));
    ...
    it('should throw running filter command on none array', () => {
        let source = {x: {}};
        expect(() => update(source, {x: {$reduce: [(sum, value) => sum + value, 0]}})).toThrow();
    });
    ...
    it('should recognize merge command', () => {
        ...
        expect(source).toEqual(createSourceObject());
        expect(diff).toEqual({x: {y: Object.assign(diffOfAdd('a', 1), diffOfAdd('b', 2))}});
    });
    ...
    it('should accept merge command on null objects', () => {
        ...
        expect(diff).toEqual({y: diffOfAdd('b', 2)});
    });
    ...
    it('should recognize apply command', () => {
        ...
        expect(result.tom.jack).toBe(2);
        expect(result.rabbit).toBe(3);
        expect(source).toEqual(createSourceObject());
        expect(diff).toEqual(Object.assign(diffOfChange(['tom', 'jack'], 1, 2), diffOfAdd('rabbit', 3)));
    });
    ...
    it('should recognize omit command', () => {
        ...
        expect(source).toEqual(createSourceObject());
        expect(diff).toEqual(diffOfRemove(['tom', 'jack'], 1));
    });
    ...
    it('should recognize omit command on array', () => {
        ...
        expect(diff).toEqual(diffOfRemove('1', 2));
    });
    ...
    it('should recognize composeBefore command', () => {
        ...
        expect(diff).toEqual(diffOfChange('foo', raw, result.foo));
    });

    it('should throw running composeBefore command on none function', () => {
        let source = {foo: {}};
        expect(() => update(source, {foo: {$composeBefore() {}}})).toThrow();
    });
    ...
    it('should throw running composeAfter command on none function', () => {
        let source = {foo: {}};
        expect(() => update(source, {foo: {$composeAfter() {}}})).toThrow();
    });
    ...
    describe('run with first level command', () => {
        it('should work with $set', () => {
            ...
            expect(diff).toEqual(diffOfChange(null, source, 1));
        });
        ...
        it('should work with $push', () => {
            ...
            expect(diff).toEqual(diffOfArray(null, [1, 2, 3], [1, 2, 3, 4], 3, 0, [4]));
        });
        ...
        it('should work with $unshift', () => {
            ...
            expect(source).toEqual([1, 2, 3]);
            expect(diff).toEqual(diffOfArray(null, [1, 2, 3], [0, 1, 2, 3], 0, 0, [0]));
        });
        ...
        it('should work with $map', () => {
            ...
            expect(diff).toEqual(diffOfChange(null, [1, 2, 3], [2, 3, 4]));
        });
        ...
        it('should work with $filter', () => {
            ...
            expect(diff).toEqual(diffOfChange(null, [1, 2, 3], [2, 3]));
        });
        ...
        it('should work with $reduce', () => {
            ...
            expect(diff).toEqual(diffOfChange(null, [1, 2, 3], 6));
        });
        ...
        it('should work with $merge', () => {
            ...
            expect(diff).toEqual(Object.assign(diffOfChange('foo', 1, 3), diffOfAdd('bar', 2)));
        });
        ...
        it('should work with $defaults', () => {
            ...
            expect(source).toEqual({foo: 1});
            expect(diff).toEqual(diffOfAdd('bar', 2));
        });
        ...
        it('should work with $apply', () => {
            ...
            expect(diff).toEqual(diffOfChange(null, 1, 2));
        });
        ...
        it('should work with $composeBefore', () => {
            ...
            result(1);
            expect(cache).toEqual([1, 2]);
            expect(diff).toEqual(diffOfChange(null, raw, result));
        });
